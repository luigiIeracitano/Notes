...
\lecture{7}{31-03-2026}{Kernel Methods}{}
...
\subsubsection{Examples of kernel functions}
...
\begin{center}
\includegraphics[width=0.25\linewidth]{images/img_20260402_135010.png}
\includegraphics[width=0.25\linewidth]{images/img_20260402_135030.png}
\includegraphics[width=0.25\linewidth]{images/img_20260402_135046.png}  
\end{center}
\subsubsection{Trick}
...
function. This trick is called $kernelizing$ an algorithm (not only for linear model !).
...
\[
  k(X, x_i) = \begin{pmatrix} k(x_1, x_i) \\ k(x_2, x_i) \\ \vdots \\ k(x_N, x_i)    
