...
\includegraphics[width=0.5\linewidth]{images/img_20260414_004200.png}
...
\[
  \tilde{x}_i^{(d)} = \frac{x_i^{(d)} - x_{min}^{(d)}}{x_{max}^{(d)} - x_{max}^{(d)}}
\]
...
\includegraphics[width=0.5\linewidth]{images/img_20260414_011415.png}
