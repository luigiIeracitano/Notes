...
discussed so far (e.g., feature expansion, kernel methods, bag of (visual) words, \dots) were all manually designed, it doesn't guarantee that they are the best
representations for the task at hand. 

Ideally, one would therefore like to learn the representation
jointly with the classifier, it leads us to \textbf{neural networks}.
