...
A natural application of K-means is image segmentation by color (Bishop, Ch.~9.1): each pixel
...
magnitudes \emph{and} represent completely different kinds of information. Consider the
