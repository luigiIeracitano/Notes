...
\paragraph{Example: Laurent expansion around $z_0$}
...
In summary, either expand in power series and take out as many common powers of $z-z_0$ from the nominator and denominator, and take the \textbf{limit} or use \textbf{l'Hôpital's rule}:
