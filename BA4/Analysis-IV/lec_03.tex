...
\lecture{3}{05-03-2026}{Integration and Cauchy theorem}{}
...
If $\Gamma$ is closed and $\nabla \times F = 0$ in the interior of $\Gamma$ then by Stoke's Theorem
...
\textbf{Integral of $z^2$ on the unit circle}
